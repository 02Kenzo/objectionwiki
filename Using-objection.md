...
* You have successfully patched your application (ie: [an IPA](Patching-iOS-Applications) or [an APK]()), or added the FridaGadget to your project and deployed it to a device.
